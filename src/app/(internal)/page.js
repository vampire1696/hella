    ...
    <main className="flex-col flex items-center ">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <Link href="/courses">
                <CustomCard
                  ...
                  title="Courses"
                  desc="Discover our training course and elevate your skills"
                />
              </Link>
              <Link href="/news">
                <CustomCard
                  ...
                  desc="Individual learning paths for specific focus topics"
                />
              </Link>
              <Link href="/new-proposals">
                <CustomCard
                  icon="mdi:head-idea"
                  title="Skills"
                  desc="Linkage to the role specific skill matrix incl. training "
                />
              </Link>
            </div>
          </div>
      ...
      <CustomContainer className="bg-white">
        <div className="flex justify-center">
          <CountUpAnimation start={0} end={400} text="Courses" />
          <CountUpAnimation start={0} end={30000} text="Participants" />
          <CountUpAnimation start={0} end={4} text="Rating" />
          <CountUpAnimation start={0} end={1000} text="Visit a month" />
        </div>
      </CustomContainer>
